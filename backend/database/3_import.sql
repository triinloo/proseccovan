...
INSERT INTO event (id, created_by_user_id, name, location, start_date, end_date, description, image_url) VALUES (default, 1, 'Food & Wine Fair', 'Tallinn', '2026-08-15', '2026-08-15', 'Experience gourmet food and exquisite wines, featuring our finest prosecco.', null);
INSERT INTO event (id, created_by_user_id, name, location, start_date, end_date, description, image_url) VALUES (default, 1, 'Local Market Day', 'Tartu', '2026-09-10', '2026-09-10', 'Visit our stall at the local market for a delightful prosecco tasting.', null);
