...
INSERT INTO event (id, created_by_user_id, name, location, start_date, end_date, description, image_url) VALUES (default, 1, 'Toidu- ja veinimess', 'Tallinn', '2026-08-15', '2026-08-15', 'Nautige gurmeesöögiga ja peeneid veine, millega kaasas meie parim prosecco.', null);
INSERT INTO event (id, created_by_user_id, name, location, start_date, end_date, description, image_url) VALUES (default, 1, 'Kohalik laadapäev', 'Tartu', '2026-09-10', '2026-09-10', 'Külastage meie laabastandi kohalikul laadal ja nautige prosecco degusteerimist.', null);
INSERT INTO event (id, created_by_user_id, name, location, start_date, end_date, description, image_url) VALUES (default, 1, 'Suvefestival', 'Pärnu', '2026-07-01', '2026-07-03', 'Kolm päeva muusikat ja proseccot Pärnu rannas.', null);